...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-y-auto backdrop-blur-sm py-8">
      <motion.div
        className="relative max-w-2xl w-full mx-4 border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10 my-auto"
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            {href && (
              <a href={href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 font-medium cursor-pointer hover-animation">
                View Project{" "}
                <img src="assets/arrow-up.svg" className="size-4" alt="External link arrow" />
              </a>
            )}
          </div>
        </div>
